          ...
          {projects.map((project, idx) => (
            <Dialog key={project.id}>
              <DialogTrigger asChild>
                ...
                >
                  <div className="absolute inset-0 z-10 bg-background/0 group-hover:bg-background/20 transition-colors duration-500" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 h-auto max-h-[80vh] overflow-y-auto hide-scrollbar">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center bg-zinc-950">
                    <DialogHeader>
                      ...
                      <DialogTitle className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-6 leading-tight wrap-break-word">
                        {project.title}
                      </DialogTitle>
                    ...
                    <div className="mt-12 pt-8 border-t border-foreground/10 flex flex-col gap-4">
                      <div className="flex gap-4">
                        <div className="flex-1">
                          ...
                          <span className="text-sm text-foreground">Design & Development</span>
                        </div>
                        <div className="flex-1">
                      ...
                      <button className="mt-4 w-full py-4 bg-foreground text-background font-medium tracking-widest text-xs uppercase hover:bg-zinc-200 transition-colors">
                        View Live Project
                      </button>
                    </div>
                  </div>
